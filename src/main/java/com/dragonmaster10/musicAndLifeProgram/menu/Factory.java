...
{	
	...
	public Object getObject( String className, Object parameter, String parameterName) throws FactoryException
	{
	...
	public Object getObject( String className, Object[] parameters, String[] parameterNames) throws FactoryException
	{
			return createObject(className, parameters, parameterNames);
	}
   ...
   **/
   ...
   public Object createObject( String className, Object[] parameters, String[] parameterClassNames ) throws FactoryException
   {
		int x = 0;         // counters
